...
RUN apt-get update && apt-get install -y --no-install-recommends git=1:2.11.0-3+deb9u4 \
  python-dev=2.7.13-2 python-setuptools=33.1.1-1 wget=1.18-5+deb9u2 libmariadbclient-dev=10.1.37-0+deb9u1 \
  curl=7.52.1-5+deb9u9 wkhtmltopdf=0.12.3.2-3 python-pip=9.0.1-2 sudo=1.8.19p1-2.1 \
